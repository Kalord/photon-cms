                ...
                <div id="userbox" class="userbox">
                    <a href="#" data-toggle="dropdown">
                        ...
                        <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                            ...
                            <span class="role">{{Auth()->user()->getRuleTitle()}}</span>
                        </div>
								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="admin/market/module">
													 Маркет
												</a>
											</li>
											<li>
												<a href="admin/module/load">
													 Загрузка своего модуля
												</a>
											</li>
                                    ...
                                    <li class="nav-parent">
										...
										<ul class="nav nav-children">
                                            ...
                                            <li>
												<a href="/admin/market/theme">
													Маркет
												</a>
                                            </li>
                                            <li>
												<a href="/admin/theme/load">
													Загрузить свою тему
												</a>
											</li>
										</ul>
